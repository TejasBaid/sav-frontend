...
export function Dashboard() {
  ...
  // Derive filter options from ALL teachers (unfiltered) so selection doesn't shrink other options
  ...
  // Slice trends array according to the selected time filter (backend returns all historical weeks by default)
